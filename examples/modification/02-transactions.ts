/**
 * CanL3 Modification API - Transactions & Change Tracking
 *
...
console.log('=== CanL3 Modification API - Transactions ===\n');
...
function safeUpdate(doc: CanL3Document, updates: () => void): boolean {

/**
 * CanL3 Query API - Temporal Query Examples
 *
...
console.log('=== CanL3 Query API - Temporal Queries (v2.4.0) ===\n');
...
const doc = CanL3Document.fromJSON(eventData);
...
console.log('â”€'.repeat(50));
console.log('   These expressions can be used in CanL3 queries:\n');

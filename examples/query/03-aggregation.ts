/**
 * CanL3 Query API - Aggregation Examples
 *
...
console.log('=== CanL3 Query API - Aggregation (v2.4.0) ===\n');
...
console.log('\nðŸ† Top Selling Category by Stock:');
...
console.log('\nâœ… All aggregation examples work perfectly!');

"use strict";
/**
 * CanL3 Document Tree Provider (T039)
 *
 * Provides a tree view for exploring CanL3 document structure
 */
...
exports.CanL3TreeItem = exports.CanL3TreeDataProvider = void 0;
const vscode = __importStar(require("vscode"));
const CanL3_1 = require("CanL3");
class CanL3TreeDataProvider {
    constructor() {
    ...
    async getChildren(element) {
        ...
        // No active editor or not a CanL3 file
        if (!editor || editor.document.languageId !== 'CanL3') {
            return [];
        }
        ...
        if (this.document !== editor.document) {
            ...
            try {
                ...
                this.parsedData = (0, CanL3_1.decodeCanL3)(text);
            }
            catch (error) {
                // If parsing fails, show error message
                return [
                    new CanL3TreeItem('Parse Error', vscode.TreeItemCollapsibleState.None, error instanceof Error ? error.message : 'Unknown error', 'error')
                ];
            }
        }
    ...
    buildTreeItems(data, parentPath = '') {
        ...
        if (Array.isArray(data)) {
            ...
            data.forEach((item, index) => {
                ...
                items.push(new CanL3TreeItem(`[${index}]`, collapsibleState, item, this.getValueType(item), path));
            });
        }
            ...
            Object.entries(data).forEach(([key, value]) => {
                ...
                items.push(new CanL3TreeItem(key, collapsibleState, value, this.getValueType(value), path));
            });
        }
        return items;
    }
...
exports.CanL3TreeDataProvider = CanL3TreeDataProvider;
class CanL3TreeItem extends vscode.TreeItem {
...
exports.CanL3TreeItem = CanL3TreeItem;

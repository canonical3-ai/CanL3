# CanL3: Building a Token-Optimized Serialization Format from Scratch

> A comprehensive guide to how CanL3 (Token-Optimized Notation Language) was designed, implemented, and evolved into a production-ready TypeScript library.
...
CanL3 was designed to solve this by creating a format that LLMs can process efficiently while humans can still read and write.
...
**Problems:**
1. Keys repeated for every object (`"id"`, `"name"`, `"email"`, `"role"` Ã— 3)
...
CanL3 prioritizes human readability over byte efficiency. The format should be:
...
`decodeCanL3(encodeCanL3(json)) === json` must always be true:
...
â”‚     CanL3Document  |  encodeCanL3  |  decodeCanL3  |  CLI     â”‚
â”œâ”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”¤
â”‚                   FEATURE MODULES                           â”‚
â”‚  Query | Modification | Navigation | Schema | Streaming    â”‚
â”œâ”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”¤
â”‚                   CORE PROCESSING                           â”‚
â”‚           encode.ts  |  decode.ts  |  infer.ts             â”‚
â”œâ”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”¤
â”‚                   PARSER MODULES                            â”‚
â”‚  block-parser | content-parser | value-parser | line-parserâ”‚
â”œâ”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”¤
â”‚                   UTILITY LAYER                             â”‚
â”‚    strings.ts | metrics.ts | security.ts | errors.ts       â”‚
â”œâ”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”¤
...
â”œâ”€â”€ document.ts           # CanL3Document class
â”œâ”€â”€ encode.ts             # JSON â†’ CanL3
â”œâ”€â”€ decode.ts             # CanL3 â†’ JSON
â”œâ”€â”€ parser.ts             # Low-level parsing
â”œâ”€â”€ infer.ts              # Type inference
â”œâ”€â”€ parser/               # Modular parser
â”‚   â”œâ”€â”€ block-parser.ts
â”‚   â”œâ”€â”€ content-parser.ts
â”‚   â”œâ”€â”€ value-parser.ts
â”‚   â”œâ”€â”€ line-parser.ts
â”‚   â””â”€â”€ utils.ts
â”œâ”€â”€ query/                # Query system (14 files)
â”œâ”€â”€ modification/         # CRUD operations (9 files)
â”œâ”€â”€ navigation/           # Tree traversal (3 files)
â”œâ”€â”€ schema/               # Validation (5 files)
â”œâ”€â”€ indexing/             # Performance (6 files)
â”œâ”€â”€ stream/               # Streaming (5 files)
â”œâ”€â”€ optimization/         # Token optimization (11 files)
...
### 5.1 The CanL3 Format Specification
...
```typescript
function encodeValue(value: CanL3Value, key: string, ctx: Context): string {
...
Input Array
    â”‚
    â”œâ”€ All same-structure objects? â”€â”€â”€â”€â–º Tabular Format
    â”‚   â””â”€ keys[N]{col1,col2}:
    â”‚        val1, val2
    â”‚
    â”œâ”€ Mixed object structures? â”€â”€â”€â”€â”€â”€â”€â–º Indexed Format
    â”‚   â””â”€ [0]{col1,col2}: val1, val2
    â”‚      [1]{col3}: val3
    â”‚
    â””â”€ Primitive values? â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â–º Inline Format
        â””â”€ items[N]: val1, val2, val3
```

#### Step 4: Smart Delimiter Selection

```typescript
function selectOptimalDelimiter(data: CanL3Value): CanL3Delimiter {
...
â”Œâ”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”
â”‚ HEADER PARSING                                          â”‚
â”‚ - #version directive                                    â”‚
â”‚ - #delimiter directive                                  â”‚
â”‚ - @metadata directives                                  â”‚
â””â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”¬â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”˜
                        â”‚
                        â–¼
â”Œâ”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”
â”‚ LINE CLASSIFICATION                                     â”‚
â”‚ - Block header? (key{...}: or key[N]:)                 â”‚
â”‚ - Simple key-value? (key: value)                       â”‚
â”‚ - Array row? (indented values)                         â”‚
â””â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”¬â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”˜
                        â”‚
            â”Œâ”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”¼â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”
            â–¼           â–¼           â–¼
â”Œâ”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â” â”Œâ”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â” â”Œâ”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”
â”‚ BLOCK PARSER  â”‚ â”‚ VALUE     â”‚ â”‚ LINE PARSER   â”‚
â”‚ - Objects     â”‚ â”‚ PARSER    â”‚ â”‚ - Primitives  â”‚
â”‚ - Arrays      â”‚ â”‚ - Inline  â”‚ â”‚ - Type coerce â”‚
...
```typescript
function detectDelimiter(lines: string[]): CanL3Delimiter {
  ...
  return Object.entries(counts)
    .sort((a, b) => b[1] - a[1])[0][0] as CanL3Delimiter;
}
```

### 5.4 Type Inference System

#### Encoding: JavaScript â†’ CanL3 Types

```typescript
function inferPrimitiveType(value: unknown): CanL3Type {
...
#### Decoding: String â†’ JavaScript Values

```typescript
function parsePrimitiveValue(raw: string): CanL3Primitive {
...
The query system implements a JSONPath-like syntax for extracting data from CanL3 documents.
...
â”‚ PATH PARSER (path-parser.ts)           â”‚
â”‚ - Tokenization                         â”‚
â”‚ - AST generation                       â”‚
...
â””â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”˜
    ...
    â–¼ AST
â”Œâ”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”
â”‚ EVALUATOR (evaluator.ts)               â”‚
â”‚ - Tree traversal                       â”‚
â”‚ - Node matching                        â”‚
â”‚ - Result collection                    â”‚
â”‚   â”œâ”€â”€ filter-evaluator.ts (filters)   â”‚
â”‚   â”œâ”€â”€ aggregators.ts (sum, avg, etc.) â”‚
â”‚   â”œâ”€â”€ fuzzy-matcher.ts (fuzzy search) â”‚
â”‚   â””â”€â”€ temporal-evaluator.ts (dates)   â”‚
â””â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”˜
    â”‚
    â–¼
â”Œâ”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”
â”‚ CACHE (cache.ts)                       â”‚
â”‚ - LRU cache with 1000 entries         â”‚
â”‚ - Document identity tracking          â”‚
â”‚ - Cache invalidation on mutation      â”‚
â””â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”˜
```
...
for await (const user of streamQuery('huge.CanL3', 'users[*]')) {
  processUser(user);
}
...
const count = await streamCount('data.CanL3', 'items[*]');
```
...
test('complex nested structure round-trips perfectly', () => {
  ...
  const CanL3 = encodeCanL3(input);
  const output = decodeCanL3(CanL3);
...
test('prevents prototype pollution', () => {
  ...
  const result = decodeCanL3(malicious);
...
| Dataset | JSON Tokens | CanL3 Tokens | Reduction |
|---------|-------------|-------------|-----------|
...
```typescript
function encodeSmart(data: CanL3Value): string {
  ...
  return encodeCanL3(data, options);
}
```
...
CanL3 demonstrates that significant token optimization is achievable without sacrificing human readability or developer experience. The project evolved from a simple encoding experiment to a production-ready library with:
...
The 32-45% token reduction translates directly to cost savings when working with LLMs, making CanL3 a practical choice for LLM-intensive applications.

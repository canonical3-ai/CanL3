/**
 * TypeScript type generation from CanL3 schemas
 */

import type { CanL3Schema, SchemaType, SchemaField, CustomTypeDefinition } from './types.js';

/**
 * Generate TypeScript type definitions from a CanL3 schema
 */
export function generateTypeScript(schema: CanL3Schema, options?: {
  exportAll?: boolean;
  readonly?: boolean;
  strict?: boolean;
}): string {
  ...
  // Header
  lines.push('/**');
  lines.push(' * Auto-generated TypeScript types from CanL3 schema');
  lines.push(' * Do not edit manually - regenerate with: CanL3 generate-types');

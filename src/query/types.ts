/**
 * Type definitions for CanL3 Query API
 *
 ...
 * Example: user.name â†’ { type: 'property', name: 'name' }
 */
 ...
 * Examples:
 * - users[0] â†’ { type: 'index', index: 0 }
 * - users[-1] â†’ { type: 'index', index: -1 } (last element)
 */
 ...
 * Examples:
 * - $..email â†’ find all 'email' properties at any level
 * - $.. â†’ find all nodes at any level
 */
 ...
 * Array slice node
 * Examples:
 * - users[0:5] â†’ { type: 'slice', start: 0, end: 5, step: 1 }
 * - users[:3] â†’ { type: 'slice', start: undefined, end: 3, step: 1 }
 * - users[2:] â†’ { type: 'slice', start: 2, end: undefined, step: 1 }
 * - users[::2] â†’ { type: 'slice', start: undefined, end: undefined, step: 2 }
 */
 ...
 * Examples:
 * - @.role â†’ current item's role property
 * - @.user.email â†’ nested property access
 */

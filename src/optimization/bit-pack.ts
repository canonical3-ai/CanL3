...
export class BitPacker {
  ...
  /**
   * Encode packed values to CanL3-compatible string format
   *
   * Formats:
   ...
   * @returns CanL3-compatible string
   */
  ...
  /**
   * Decode CanL3-compatible string to packed values
   *
   ...
   *
   * @param directive - CanL3 directive like "@bitpack flags 1 100"

...
export class NumericQuantizer {
   ...
   *
   * Examples:
   * - 0.00123 â†’ 0.00123 (keep 5 decimals for small values)
   * - 123.456 â†’ 123.46 (keep 2 decimals for large values)
   * - 0.1 â†’ 0.1 (keep 1 decimal if significant)
   *
   * @param value - Number to quantize
   * @returns Quantized value
   */
   ...
   * @returns CanL3 directive string
   */
   ...
   *
   * @param directive - CanL3 directive like "@precision price=2"

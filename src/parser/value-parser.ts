...
import type { CanL3ParseContext, CanL3Value, CanL3Object, CanL3ObjectHeader } from '../types.js';
import { parseCanL3Line } from '../parser.js';
 ...
 */
export function parseSingleLineObject(header: CanL3ObjectHeader | null, valuePart: string, context: CanL3ParseContext): CanL3Value {
  if (!header) {

/**
 * CanL3 Error classes with enhanced reporting
 */
...
/**
 * Base CanL3 error class with location tracking
 */
export class CanL3Error extends Error {
  constructor(
    message: string,
...
/**
 * Parse error - syntax errors in CanL3 format
 */
export class CanL3ParseError extends CanL3Error {
  constructor(
    message: string,
    line?: number,
    column?: number,
 ...
 */
export class CanL3ValidationError extends CanL3Error {
  constructor(
    message: string,
    ...
    this.name = 'CanL3ValidationError';
  }
 ...
 */
export class CanL3TypeError extends CanL3Error {
  constructor(
    message: string,
    public readonly expected: string,
    public readonly actual: string,

...
The CanL3 Query API provides JSONPath-like query capabilities for accessing and filtering data in CanL3 documents. It supports path-based access, wildcards, filters, recursive descent, and array slicing.

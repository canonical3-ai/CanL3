 ...
 *
 * This test suite validates ALL queriable features of CanL3 with complex nested JSON structures,
...
describe("Comprehensive Query Features - Complete Coverage", () => {
  ...
  test("setup - create complex test document", () => {
    ...
    const CanL3 = encodeCanL3(testData);
    doc = CanL3Document.parse(CanL3);
    assert.ok(doc);
  });

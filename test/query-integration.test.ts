...
describe('Integration: Aggregation + CanL3Document', () => {
  let doc: CanL3Document;

  before(() => {
    doc = CanL3Document.fromJSON({
      products: [
...
describe('Integration: Fuzzy Matching Algorithms', () => {
  ...
  describe('Edge cases', () => {
    ...
    it('should handle unicode characters', () => {
      ...
      assert.strictEqual(levenshteinDistance('naÃ¯ve', 'naive'), 1);
    });
